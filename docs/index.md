...
- `backend/app/models/`：SQLAlchemy 模型，当前包含题目、题目分类、题目分类关系、本地用户、登录 session、LLM API 资产、LLM Run、Agent Trace、目标校准草稿、学习计划、计划版本、阶段、计划项、变更日志、画像补强计划草稿、训练会话、训练事件、代码快照、LeetCode 回填、教练回合、单题复盘、画像快照和画像增量。
