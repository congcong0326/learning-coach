...
_DEFAULT_LANGUAGE_CONTEXT_PROMPT = get_prompt("default_language_context")
_FOLLOWUP_PROMPT = get_prompt("legacy_learning_followup")
_PLAN_DRAFT_PROMPT = get_prompt("legacy_learning_plan_draft")
_REPAIR_PLAN_PROMPT = get_prompt("legacy_learning_plan_repair")

PROMPT_VERSION = _PLAN_DRAFT_PROMPT.version
DEFAULT_LANGUAGE_CONTEXT_INSTRUCTIONS = _DEFAULT_LANGUAGE_CONTEXT_PROMPT.instructions
FOLLOWUP_INSTRUCTIONS = _FOLLOWUP_PROMPT.instructions
